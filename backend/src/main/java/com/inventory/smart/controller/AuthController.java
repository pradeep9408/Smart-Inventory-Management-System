...
import com.inventory.smart.dto.JwtResponse;
import com.inventory.smart.dto.LoginRequest;
import com.inventory.smart.dto.MessageResponse;
import com.inventory.smart.dto.SignupRequest;
...
import com.inventory.smart.security.JwtUtils;
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        if (strRoles == null || strRoles.isEmpty()) {
            Role userRole = roleRepository.findByName(ERole.ROLE_EMPLOYEE)
                    .orElseThrow(() -> new ResourceNotFoundException("Role", "name", ERole.ROLE_EMPLOYEE));
            roles.add(userRole);
        } else {
                ...
                switch (role) {
                    ...
                    case "ROLE_MANAGER":
                        Role managerRole = roleRepository.findByName(ERole.ROLE_MANAGER)
                                .orElseThrow(() -> new ResourceNotFoundException("Role", "name", ERole.ROLE_MANAGER));
